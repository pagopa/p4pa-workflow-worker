...
@WebMvcTest(value = {WorkerExceptionHandlerTest.TestController.class})
...
class WorkerExceptionHandlerTest {
  ...
  void handleMissingServletRequestParameterException() throws Exception {
    performRequest(null, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Required request parameter 'data' for method parameter type String is not present"))
  ...
  void handleRuntimeExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_GENERIC_ERROR] Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handle4xxHttpServletException() throws Exception {
    performRequest(DATA, MediaType.parseMediaType("application/hal+json"))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] No acceptable representation"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleUrlNotFound() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.post("/NOTEXISTENTURL"))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_NOT_FOUND"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_NOT_FOUND"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_NOT_FOUND] No static resource NOTEXISTENTURL for request '/NOTEXISTENTURL'."))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleNoBodyException() throws Exception {
    performRequest(DATA, MediaType.APPLICATION_JSON, null)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Required request body is missing"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleMalformedBodyException() throws Exception {
    performRequest(DATA, MediaType.APPLICATION_JSON,
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Cannot parse body. Unexpected end-of-input: was expecting closing '\"' for name"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleInvalidBodyException() throws Exception {
    performRequest(DATA, MediaType.APPLICATION_JSON,
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Invalid request content. lowerCaseAlphabeticField: must match \"[a-z]+\"; requiredField: must not be null"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleNotParsableBodyException() throws Exception {
    performRequest(DATA, MediaType.APPLICATION_JSON,
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Cannot parse body. dateTimeField: Text '2025-02-05' could not be parsed at index 10"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handle5xxHttpServletException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_GENERIC_ERROR] 500 INTERNAL_SERVER_ERROR \"Error\""))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleHttpClientErrorTooManyRequestsException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_TOO_MANY_REQUESTS"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_TOO_MANY_REQUESTS"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_TOO_MANY_REQUESTS] 429 TooManyRequests"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleViolationException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("WORKER_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[WORKER_BAD_REQUEST] Invalid request content. fieldName: resolved message"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
